                    ...
                    <?php foreach ($applications as $app): ?>
                        <tr data-status="<?php echo isset($app['status_id']) ? $app['status_id'] : '0'; ?>" data-visa="<?php echo isset($app['visa_id']) ? $app['visa_id'] : ''; ?>" data-priority="<?php echo isset($app['priority']) ? $app['priority'] : 'normal'; ?>">
                            ...
                            <td class="actions-cell">
                                <a href="view_application.php?id=<?php echo $app['application_id']; ?>" class="btn-action btn-view" title="View Details">
                                    <i class="fas fa-eye"></i>
                                </a>
                                
                                <button type="button" class="btn-action btn-status" 
                                        title="Update Status" onclick="openStatusModal(<?php echo $app['application_id']; ?>, <?php echo isset($app['status_id']) ? $app['status_id'] : '0'; ?>)">
                                    <i class="fas fa-exchange-alt"></i>
                                </button>
                                
                                <button type="button" class="btn-action btn-assign" 
                                        title="Assign Case Manager" onclick="openAssignModal(<?php echo $app['application_id']; ?>, '<?php echo isset($app['team_member_id']) ? $app['team_member_id'] : ''; ?>')">
                                    <i class="fas fa-user-plus"></i>
                                </button>
                                
                                <a href="application_documents.php?id=<?php echo $app['application_id']; ?>" class="btn-action btn-document" title="Manage Documents">
                                    <i class="fas fa-file-alt"></i>
                                </a>
                                
                                <a href="application_comments.php?id=<?php echo $app['application_id']; ?>" class="btn-action btn-comment" title="Comments (<?php echo isset($app['comment_count']) ? $app['comment_count'] : '0'; ?>)">
