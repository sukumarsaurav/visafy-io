...
// Get all clients (applicants who have bookings with the organization)
...
if (isset($_GET['search']) && !empty($_GET['search'])) {
    ...
    $search_stmt->bind_param('issss', $organization_id, $search_param, $search_param, $search_param, $search_param);
    $search_stmt->execute();
                    ...
                    <?php foreach ($clients as $client): ?>
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($client['relationship_type'])): ?>
                                    <span class="relationship-badge <?php echo $client['relationship_type']; ?>">
                                        <?php echo ucfirst($client['relationship_type']); ?>
                                    </span>
                                <?php else: ?>
                            ...
                            <td class="actions-cell">
                                ...
                                <button type="button" class="btn-action btn-relationship" 
                                        title="Update Relationship" onclick="openRelationshipModal(<?php echo $client['id']; ?>, '<?php echo $client['relationship_type']; ?>')">
            ...
            <div class="modal-body">
                <form action="update_client_relationship.php" method="POST" id="relationshipForm">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="notes" id="relationship_notes" class="form-control" rows="3"></textarea>
                    </div>
